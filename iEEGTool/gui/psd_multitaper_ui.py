...
# Form implementation generated from reading ui file 'psd_multitaper.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(324, 409)
        MainWindow.setMinimumSize(QtCore.QSize(324, 409))
        MainWindow.setMaximumSize(QtCore.QSize(324, 409))
        font = QtGui.QFont()
        ...
        self.horizontalLayout.addWidget(self.Multitaper_method_lb)
        ...
        self._half_bandwidth_lb = QtWidgets.QLabel(self.groupBox)
        self._half_bandwidth_lb.setMinimumSize(QtCore.QSize(100, 25))
        self._half_bandwidth_lb.setMaximumSize(QtCore.QSize(200, 25))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(9)
        font.setBold(False)
        font.setItalic(False)
        font.setWeight(50)
        self._half_bandwidth_lb.setFont(font)
        self._half_bandwidth_lb.setObjectName("_half_bandwidth_lb")
        self.verticalLayout_2.addWidget(self._half_bandwidth_lb)
        ...
        self._half_bandwidth_le = QtWidgets.QLineEdit(self.groupBox)
        self._half_bandwidth_le.setMinimumSize(QtCore.QSize(100, 25))
        self._half_bandwidth_le.setMaximumSize(QtCore.QSize(100, 25))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self._half_bandwidth_le.setFont(font)
        self._half_bandwidth_le.setFocusPolicy(QtCore.Qt.ClickFocus)
        self._half_bandwidth_le.setAlignment(QtCore.Qt.AlignCenter)
        self._half_bandwidth_le.setObjectName("_half_bandwidth_le")
        self.verticalLayout.addWidget(self._half_bandwidth_le)
        ...
        self.verticalLayout_6.addWidget(self._average_chs_lb)
        ...
        self.verticalLayout_6.addWidget(self._log_trans_lb)
        ...
        self._average_chs_cbx.addItem("")
        self.verticalLayout_5.addWidget(self._average_chs_cbx)
        ...
        self._log_trans_cbx.addItem("")
        self.verticalLayout_5.addWidget(self._log_trans_cbx)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self._half_bandwidth_lb.setText(_translate("MainWindow", "Bandwidth (Hz)"))
        self._n_jobs_lb.setText(_translate("MainWindow", "Number of jobs"))
        self._select_chan_btn.setText(_translate("MainWindow", "..."))
        self._half_bandwidth_le.setText(_translate("MainWindow", "1"))
