...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self._seeg_viz_stack = QtWidgets.QStackedWidget(self.centralwidget)
        self._seeg_viz_stack.setFocusPolicy(QtCore.Qt.NoFocus)
        self._seeg_viz_stack.setStyleSheet("")
        self._seeg_viz_stack.setObjectName("_seeg_viz_stack")
        self.verticalLayout.addWidget(self._seeg_viz_stack)
        ...
        self._resample_seeg_action = QtWidgets.QAction(MainWindow)
        self._resample_seeg_action.setObjectName("_resample_seeg_action")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../icon/mri.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self._load_t1_action.setIcon(icon)
        ...
        self._load_seeg_action = QtWidgets.QAction(MainWindow)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../../icon/ieeg.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self._load_seeg_action.setIcon(icon1)
        self._load_seeg_action.setObjectName("_load_seeg_action")
        self._load_coordinates_action = QtWidgets.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../../icon/electrodes.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self._load_coordinates_action.setIcon(icon2)
        ...
        self._preference_action = QtWidgets.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../../icon/subject.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self._preference_action.setIcon(icon3)
        self._preference_action.setObjectName("_preference_action")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../../icon/ct.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self._load_ct_action.setIcon(icon4)
        self._load_ct_action.setObjectName("_load_ct_action")
        self._export_seeg_action = QtWidgets.QAction(MainWindow)
        self._export_seeg_action.setObjectName("_export_seeg_action")
        ...
        self._crop_seeg_action = QtWidgets.QAction(MainWindow)
        self._crop_seeg_action.setObjectName("_crop_seeg_action")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../../icon/github.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self._github_action.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("../../icon/montage.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self._set_montage_action.setIcon(icon6)
        ...
        self._channels_info_action.setIcon(icon2)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("../../icon/screenshot.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self._screenshot_action.setIcon(icon7)
        self._screenshot_action.setObjectName("_screenshot_action")
        self._ieeg_toolbar_action = QtWidgets.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("../../icon/toolbar.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self._ieeg_toolbar_action.setIcon(icon8)
        ...
        self.actionFIR_filter = QtWidgets.QAction(MainWindow)
        self.actionFIR_filter.setObjectName("actionFIR_filter")
        self.actionIIR_filter = QtWidgets.QAction(MainWindow)
        self.actionIIR_filter.setObjectName("actionIIR_filter")
        self._toolbar.addAction(self._load_t1_action)
        self._toolbar.addAction(self._load_ct_action)
        self._toolbar.addAction(self._load_seeg_action)
        self._toolbar.addSeparator()
        self._toolbar.addAction(self._crop_seeg_action)
        self._toolbar.addAction(self._resample_seeg_action)
        self._toolbar.addAction(self.actionFIR_filter)
        self._toolbar.addSeparator()
        self._toolbar.addAction(self._channels_info_action)
        self._toolbar.addAction(self._set_montage_action)
        self._toolbar.addAction(self._preference_action)
        self._toolbar.addSeparator()
        ...
        self.menuFile.addAction(self._load_seeg_action)
        self.menuFile.addAction(self._export_seeg_action)
        self.menuFile.addSeparator()
        ...
        self.menuFile.addSeparator()
        self.menuFile.addAction(self._preference_action)
        ...
        self.menuFilter.addAction(self.actionFIR_filter)
        self.menuFilter.addAction(self.actionIIR_filter)
        self.menuProcess.addAction(self._set_montage_action)
        self.menuProcess.addSeparator()
        self.menuProcess.addAction(self._crop_seeg_action)
        self.menuProcess.addAction(self._resample_seeg_action)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self._resample_seeg_action.setText(_translate("MainWindow", "Resample"))
        ...
        self._load_seeg_action.setText(_translate("MainWindow", "Load SEEG"))
        self._load_seeg_action.setShortcut(_translate("MainWindow", "Ctrl+O"))
        ...
        self._preference_action.setText(_translate("MainWindow", "Preference"))
        ...
        self._export_seeg_action.setText(_translate("MainWindow", "Export SEEG"))
        ...
        self._crop_seeg_action.setText(_translate("MainWindow", "Crop"))
        ...
        self._get_anatomy_action.setText(_translate("MainWindow", "Anatomy"))
        ...
        self.actionFIR_filter.setText(_translate("MainWindow", "FIR filter"))
        self.actionIIR_filter.setText(_translate("MainWindow", "IIR filter"))
