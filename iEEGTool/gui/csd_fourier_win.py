...
class FourierCSDWin(QMainWindow, Ui_MainWindow):
    ...
    def _compute_csd(self):
        logger.info('Start computing CSD using Fourier')
        ...
        self._compute_csd_fourier_thread = ComputeCSD(ieeg, compute_method='fourier',
                                                      params=self.compute_params)
        self._compute_csd_fourier_thread.CSD_SIGNAL.connect(self._get_csd)
        self._compute_csd_fourier_thread.start()
