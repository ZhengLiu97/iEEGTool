...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(811, 619))
        MainWindow.setMaximumSize(QtCore.QSize(811, 619))
        font = QtGui.QFont()
        ...
        self.Morlet_method_lb = QtWidgets.QLabel(self.groupBox)
        self.Morlet_method_lb.setMinimumSize(QtCore.QSize(0, 25))
        self.Morlet_method_lb.setMaximumSize(QtCore.QSize(16777215, 25))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.Morlet_method_lb.setFont(font)
        self.Morlet_method_lb.setObjectName("Morlet_method_lb")
        self.horizontalLayout.addWidget(self.Morlet_method_lb)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Morlet_method_lb.setText(_translate("MainWindow", "Morlet Method"))
